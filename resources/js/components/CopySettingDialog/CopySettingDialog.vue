          ...
          <v-window v-model="formstep">
            <v-window-item :value="1">
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isOpenTradesInDestination"
                ...
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isOpenPendingOrdersInDestination"
              ...
              <v-row>
                <v-col class="py-0">
                  <v-select
                    v-model="form.copyDirection"
                    :items="copyDirections"
                ...
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isCloseTradesInDestination"
              ...
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isDeletePendingOrdersInDestination"
                ...
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isInvertTradeCopyDirection"
              ...
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isCopyTPToDestination"
                    label="Copy TP To Destination?"
                  >
                  </v-checkbox>
                  <v-text-field
                    v-model="form.overrideDestinationTP"
                    type="number"
                    label="Override Destination TP (Pips)"
                  >
                  </v-text-field>
                </v-col>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isCopySLToDestination"
                    label="Copy SL To Destination?"
                  >
                  </v-checkbox>
                  <v-text-field
                    v-model="form.overrideDestinationSL"
                    type="number"
                    label="Override Destination SL (Pips)"
                  >
                  </v-text-field>
                </v-col>
              </v-row>
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isCopyOpenTrades"
                    label="Copy Open trades?"
                  >
                  </v-checkbox>
                  <!-- <v-text-field
                    v-model="form.maxTime"
                    type="number"
                    :disabled="!form.isCopyOpenTrades"
                    label="Max time (mins)"
                  >
                  </v-text-field> -->
                </v-col>
                <v-col class="py-0">
                  <v-text-field
                    v-model="form.copyDelay"
                    type="number"
                    label="Copy Delay (seconds) "
                  >
                  </v-text-field>
                </v-col>
              </v-row>
            ...
            <v-window-item :value="2">
              ...
              <v-row>
                <v-col class="py-0">
                  <v-text-field
                    v-model="form.lotSizeMultipleOfSource"
                    type="number"
            ...
            <v-window-item :value="3">
              <v-row>
                <v-col>
                  <v-text-field
                    v-model="form.maximumOrdersInDestination"
                    type="number"
                ...
                <v-col>
                  <v-text-field
                    v-model="form.maximumOpenPriceSlippage"
                    type="number"
              ...
              <v-row>
                <v-col class="py-0">
                  <v-text-field
                    v-model="form.maximumOpenPriceDeviationToCopy"
                    type="number"
                ...
                <v-col class="py-0">
                  <v-text-field
                    v-model="form.maximumTimeAfterSourceOpen"
                    type="number"
              ...
              <v-row>
                <v-col class="py-0">
                  <v-text-field
                    v-model="form.dailyProfitToStop"
                    type="number"
                ...
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isCloseTradesWhenDailyProfitIsReached"
              ...
              <v-row>
                ...
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isCloseTradesWhenDailyLossIsReached"
            ...
            <v-window-item :value="4">
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isSendAlertForNewTrades"
                ...
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isSendAlertForClosedTrades"
              ...
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isSendAlertForPartiallyClosedTrades"
                ...
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isSendAlertForDailyProfitReached"
              ...
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.isSendAlertForDailyLossReached"
            ...
            <v-window-item :value="5">
              <v-row>
                <v-col cols="6">
                  <v-select
                    v-model="form.brokerServerSummerTimeZone"
                ...
                <v-col cols="6">
                  <v-select
                    v-model="form.brokerServerWinterTimeZone"
                    :items="brokerServerTimeZones"
              ...
              <v-row>
                <v-col class="py-0">
                  <v-text-field
                    v-model="form.brokerSymbolPrefix"
                    type="text"
                ...
                <v-col class="py-0">
                  <v-text-field
                    v-model="form.brokerSymbolSuffix"
                    type="text"
            ...
            <v-window-item :value="6">
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.applyTrailingStop"
                    label="ApplyTrailingStop"
                  >
                  </v-checkbox>
                </v-col>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.profitTrailing"
                    label="ProfitTrailing"
                  >
                  </v-checkbox>
                </v-col>
              </v-row>
              <v-row>
                <v-col class="py-0">
                  <v-text-field
                    ...
                    type="number"
                    label="TrailingStop (Pips)"
                  >
                  </v-text-field>
                </v-col>
                <v-col class="py-0">
                  <v-text-field
                    v-model="form.trailingProfit"
                    type="number"
                    label="TrailingProfit (Pips)"
                  >
                  </v-text-field>
                </v-col>
              </v-row>
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.applyOnOffTime"
                    label="ApplyOnOffTime"
                  >
                  </v-checkbox>
                </v-col>
                <v-col class="py-0"></v-col>
              ...
              <v-expand-transition>
                <v-row v-show="form.applyOnOffTime">
                  <v-col class="py-0">
                    <v-dialog
                      ref="onTimeDialogRef"
                      v-model="onTimeDialog"
                      :return-value.sync="form.onTime"
                      persistent
                      width="290px"
                    >
                  ...
                  <v-col class="py-0">
                    <v-dialog
                      ref="offTimeDialogRef"
                      v-model="offTimeDialog"
                      :return-value.sync="form.offTime"
                      persistent
                      width="290px"
                    >
                      <template v-slot:activator="{ on, attrs }">
            ...
            <v-window-item :value="7">
              <v-row>
                <v-col>
                  <v-checkbox
                    v-model="form.applyDestinationPair"
                ...
                <v-col>
                  <v-text-field
                    v-model="form.destinationPair"
                    label="DestinationPair"
                  >
                  </v-text-field>
                </v-col>
              </v-row>
              <v-row>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.applyMessageLog"
                    label="ApplyMessageLog"
                  >
                  </v-checkbox>
                </v-col>
                <v-col class="py-0">
                  <v-checkbox
                    v-model="form.applyOrderCloseBy"
                    label="ApplyOrderCloseBy"
                  >
                  </v-checkbox>
                </v-col>
              </v-row>
